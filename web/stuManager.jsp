...
<body>
    <div id="bigbox">
        ...
        <div>
            <a href="stu?type=mainByPage&page=1">首页</a>
            <a href="stu?type=mainByPage&page=${requestScope.pu.prePage}">上一页</a>
                ${requestScope.pu.page}/${requestScope.pu.countPage}
            <a href="stu?type=mainByPage&page=${requestScope.pu.nextPage}">下一页</a>
            <a href="stu?type=mainByPage&page=${requestScope.pu.countPage}">最后</a>
        </div>
    </div>
